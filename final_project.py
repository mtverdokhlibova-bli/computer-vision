...
while True:
    ...
    result = model.track(frame, classes = [2], conf = 0.3, verbose = False)
    if result[0].boxes.id is not None:
        ...
        for box, track_id in zip(boxes, track_ids):
            ...
            if track_id in track_history:
                ...
                cv2.putText(frame, f'id:{track_id}:{int(speed_kmh)}km/h', (x, y), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (0, 255, 0), 2)
